...
16. **`main.tsx` minimal** - Le fichier `main.tsx` ne doit contenir que `StrictMode`, BrowserRouter et `Application`. Tous les autres composants de configuration, (providers, etc.) doivent être implémentés dans `application.tsx`
